...
class ThorinSessionData {
  ...
  constructor(sessId, data, _createdAt) {
    this.#id = sessId;
    if (typeof data === 'object' && data) {
      let createTs = _createdAt || data.__tca;
      ...
      this.#initialData = JSON.stringify(this.getData(true));
    } else {
  ...
  hasChanges() {
    ...
    let currentData = JSON.stringify(this.getData(true));
